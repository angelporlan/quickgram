...
@Component({
    selector: 'app-conditionals-review',
    standalone: true,
    imports: [CommonModule],
    templateUrl: './conditionals-review.component.html',
    styleUrls: ['./conditionals-review.component.css']
})
export class ConditionalsReviewComponent implements OnInit {
    result: any;
    exercise: any;
